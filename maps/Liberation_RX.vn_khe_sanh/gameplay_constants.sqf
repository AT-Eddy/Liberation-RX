GRLIB_save_key = "GREUH_LIBERATION_KHESAN_SAVEGAME_PSK";	// change this value if you want different savegames on different map
...
GRLIB_secondary_missions_costs = [ 50, 25, 10 ];
