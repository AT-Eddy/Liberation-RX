GRLIB_save_key = "GREUH_LIBERATION_MURGHAB_SAVEGAME_PSK";	// change this value if you want different savegames on different map
GRLIB_side_resistance = RESISTANCE;
GRLIB_side_civilian = CIVILIAN;
GRLIB_respawn_marker = "respawn_west";
GRLIB_sector_size = 450;	// default 700
GRLIB_capture_size = 150;	// default 175
